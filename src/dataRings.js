...
export const RINGS_DATA = [
  {
    ...
    longDescription: `A captivating statement piece that channels timeless, antique sophistication. This ornate
  floral ring features a magnificent central bloom intricately encrusted with dozens of petite,
  diamond-cut marcasite stones. The stones catch the light with a subtle, metallic shimmer rather
  than an overwhelming sparkle, creating a moody, romantic luster. Sculpted in fine sterling silver
  with blackened accents, its layered petals evoke the dark elegance of a forgotten era — bold,
  artistic, and breathtakingly detailed.`,
  ...
  },
  {
    ...
    longDescription: `Celebrating the pure beauty of minimalist geometry, this fluid sterling silver ring wraps
  gracefully around the finger like a frozen wave. Its sleek, polished parallel bands sweep in a gentle,
  asymmetrical spiral, offering a clean yet distinctly artistic aesthetic. The high-shine mirror finish
  accentuates its smooth contours and airy structure, making it a versatile, everyday masterpiece that
  feels weightless yet speaks volumes.`,
  ...
  },
  {
    ...
    longDescription: `An exquisite, unconventional design meant to crown the fingertip with absolute glamour. This
  intricate nail ring boasts a lavish display of brilliant pavé-set crystals that form a delicate,
  crown-like lattice. Sitting proudly at its heart is a hypnotic teardrop-cut faux emerald that glows
  with deep, mantic green tones. Perfect for those who dare to be different, this piece blends
  high-fashion drama with meticulous craftsmanship, turning your hands into an immediate
  ...
  },
  {
    ...
    longDescription: `A majestic piece that captures a sense of fairytale royalty. At its center lies an exquisite
  marquise-cut crystal that flashes with a mesmerizing spectrum of deep emerald green and magical
  violet tones. The stone is cradled by a fine, crown-like halo of brilliant pavé-set accents that extend
  elegantly onto a polished sterling silver band. It is a brilliant combination of vintage grandeur and
  vibrant modern color.`,
  ...
  },
  {
    ...
    longDescription: `Lustrous, graceful, and deeply artistic. This open-cuff sterling silver ring features a smooth,
  twisting band that gracefully wraps around the finger, beautifully pairing two distinct, contrasting
  treasures. On one end sits a smooth, polished cabochon gemstone, balanced perfectly on the other by
  a striking, light green crystal precision-cut with brilliant, diamond-like facets. This clever
  asymmetric arrangement gives timeless materials a fresh, contemporary edge, evoking a sense of
  fluid movement and delicate balance. It is the perfect blend of understated chic and vibrant
  sophistication.`,
  ...
  },
  {
    ...
    longDescription: `Add a touch of timeless sophistication to your jewelry collection with this stunning
  neo-classical cameo ring. Reminiscent of iconic Wedgwood jasperware, the ring features a beautifully
  detailed white matte silhouette of a seated figure under a tree, set against a striking blue
  background. The centerpiece is encased in a gorgeous, vintage-style silver frame boasting intricate
  openwork filigree and twisted rope borders. With its romantic, antique charm and breathable
  scrollwork shoulders, this ring makes a beautiful statement piece for everyday elegance or special
  occasions.`,
